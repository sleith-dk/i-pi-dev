...
class ThermoQLE(Thermostat):
    ...
    def bind(self, beads=None, atoms=None, pm=None, nm=None, prng=None, fixdof=None):
        ...
        self.phfric=np.zeros((100,self.nndof,self.nndof)) #this is not used in the electron bath
        self.phis0=np.zeros((100,len(self.XYZEqf)))   #this is not used in the electron bath
